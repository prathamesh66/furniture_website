...
const Term_of_use = () => {
  return (
    <section className="w-full py-2">
      ...
      <div className="w-full max-w-[1320px] mx-auto my-1 px-4 sm:px-6 lg:px-8">
        ...
        <div className="my-6 sm:my-8">
          ...
          <div className="mt-5 sm:mt-6">
            <p className="font-semibold text-lg sm:text-[20px] text-[#212121de] break-words">
            ...
            <div className="mt-4 sm:mt-5">
              ...
              <p className="mt-1 text-sm sm:text-base leading-6 sm:leading-7 break-words">
              ...
              <p className="mt-4 text-sm sm:text-base leading-6 sm:leading-7 break-words">
