...
const AddSubCategory = () => {
  ...
  // Edit mode
  useEffect(() => {
    if (!editData?.subCategoryImage) return;

    let imageUrl = `http://localhost:8000/uploads/subCategory/${editData.subCategoryImage}`;
    ...
    <>
      <section className="w-full">
        ...
        <div className="mt-[30px]  border-1 border-[#ccc] rounded-lg overflow-hidden m-5">
          ...
          <div className="p-3">
            <form onSubmit={saveSubCategory} action="" className=" w-full ">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col mt-3">
                    ...
                    <input
                      ...
                      defaultValue={editData?.subCategoryOrder}
                      className="border-1 border-[#ccc] rounded-lg p-2 mt-2"
                    />
                  </div>
                </div>
